...
Source: "dist\PelmeniVPN-Service.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Run]
Filename: "{app}\PelmeniVPN-Service.exe"; Parameters: "--install"; Flags: runhidden
Filename: "{app}\{#MyAppExeName}"; Description: "Запустить Пельмени VPN"; Flags: nowait postinstall skipifsilent

[UninstallRun]
Filename: "{app}\PelmeniVPN-Service.exe"; Parameters: "--uninstall"; Flags: runhidden; RunOnceId: "UninstallPelmeniService"
